...
export const RealmChatWidget: React.FC<RealmChatWidgetProps> = ({ campaign, onAddToCampaign, onUpdateCampaign, isMockMode }) => {
  ...
  return (
    <>
        ...
        {/* Main Window */}
        {isOpen && (
            <div className="fixed bottom-6 right-6 w-[450px] h-[700px] bg-slate-900 border border-slate-700 rounded-xl shadow-2xl flex flex-col overflow-hidden z-50 animate-in slide-in-from-bottom-10 duration-200">
                {/* Header */}
