...
const rollDice = (parsed: ParsedFormula): { results: number[]; keptResults: number[]; total: number } => {
...
const formatFormula = (count: number, sides: number, keepHighest?: number, keepLowest?: number, modifier?: number): string => {
